...
class ImageTexture:
    def __init__(self, path):  # Corrected __init__ method
...
class Mesh:
    def __init__(self, program, geometry, texture=None):  # Corrected __init__ method
        self.ctx = moderngl.get_context()
...
class Scene:
    def __init__(self):
        ...
        self.texture = ImageTexture('C:/Users/LENOVO/Desktop/UNIVERSIDAD/MODELADO/CODING/1/tec.png')
        self.car_geometry = ModelGeometry('C:/Users/LENOVO/Desktop/UNIVERSIDAD/MODELADO/CODING/1/Car.obj')
        self.car = Mesh(self.program, self.car_geometry)
        self.crate_geometry = ModelGeometry('C:/Users/LENOVO/Desktop/UNIVERSIDAD/MODELADO/CODING/1/car.obj')
    ...
    def render(self):
        ...
        # Clear the context and set up depth testing
        self.ctx.clear()
